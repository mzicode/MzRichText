...
import com.mz.richtext.api.DrawableGetter;
import com.mz.richtext.api.ImageClickHandler;
import com.mz.richtext.api.SpecialTagHandler;
import com.mz.richtext.api.URLClickHandler;
import com.mz.richtext.expansion.DefaultDrawableGetter;
import com.mz.richtext.expansion.DefaultImageClickHandler;
import com.mz.richtext.expansion.DefaultURLClickHandler;
...
public class Sponge {
     ...
     * @return this
     */
    public Sponge content(String content){
        mContent = content;
        return this;
    }
     ...
     * @return this
     */
    public Sponge drawableGetter(DrawableGetter drawableGetter){
     ...
     * @return this
     */
    public Sponge specialTagHandler(List<SpecialTagHandler> specialTagHandlerList){
     ...
     * @return this
     */
    public Sponge specialTagHandler(SpecialTagHandler specialTagHandler){
     ...
     * @return this
     */
    public Sponge imageClickHandler(ImageClickHandler imageClickHandler){
     ...
     * @return this
     */
    public Sponge urlClickHandler(URLClickHandler urlClickHandler){
